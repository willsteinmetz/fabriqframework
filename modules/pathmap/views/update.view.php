...
<fieldset>
	...
	<div style="padding: 2px;">
		<label for="add_path">
			<input type="checkbox" id="add_path" name="add_path" value="1" /> Add custom path
		</label>
	</div>
	<div id="pathmap-form">
		...
		<label for="path">
			Custom path: <input type="text" name="pathmap_path" id="pathmap_path" size="50" maxlength="100" />
		</label>
	</div>
</fieldset>
<script language="JavaScript">
