...
<?php
$path = str_replace('users/login/', '', $_GET['q']);
if ($_GET['q'] != 'users/login'): ?>
...
<?php endif; ?>
		...
		<div style="padding: 2px;">
			<?php if ($anyoneCanRegister): ?><a href="<?php echo PathMap::build_path('users', 'register'); ?>">Sign up</a> |<?php endif; ?>
