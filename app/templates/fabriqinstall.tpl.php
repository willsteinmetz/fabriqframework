...
<nav id="default-nav">
  ...
  <section class="nav">
    <ul>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 1) { echo ' class="current"'; } ?>>Start</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 2) { echo ' class="current"'; } ?>>Site configuration</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 3) { echo ' class="current"'; } ?>>Database configuration</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 4) { echo ' class="current"'; } ?>>Module installation</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 5) { echo ' class="current"'; } ?>>Finish</li>
    </ul>
...
<nav id="default-nav">
  <section class="nav">
    <ul>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 1) { echo ' class="current"'; } ?>>Start</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 2) { echo ' class="current"'; } ?>>Framework updates</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 3) { echo ' class="current"'; } ?>>Module updates</li>
      <li<?php if (\Fabriq\Core\Routing::arg(2) == 4) { echo ' class="current"'; } ?>>Finish</li>
    </ul>
    <div class="clearbox">&nbsp;</div>
  </section>
</nav>
